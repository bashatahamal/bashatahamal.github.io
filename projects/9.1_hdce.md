...
date: October 2024 - December 2024, February 2025 - May 2025
labels:
    - LLM Agents
    - Real-time AI
    - Prototyping
summary: Ran AI prototyping across two engagements, covering live multilingual speech translation, LLM agent platforms, and financial automation prototypes.

describe-opening: >
  HDCE is a Canadian IT and cybersecurity firm with a fintech subsidiary,
  TIB Finance. Across two engagements I ran their AI prototyping, turning
  early-stage ideas into working systems across very different domains: a
  real-time multilingual audio translator, an LLM agent and RAG platform with
  human-in-the-loop review, and automated financial workflows on the
