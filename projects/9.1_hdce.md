...
labels:
    ...
    - Real-time AI
    - Prototyping
summary: The CEO's AI engineering partner across two engagements, covering live multilingual speech translation, LLM agent platforms, and financial automation prototypes.

describe-opening: >
  HDCE is a Canadian IT and cybersecurity firm with a fintech subsidiary,
  TIB Finance. Across two engagements I worked directly with the CEO as an AI
  engineering partner, taking rough ideas to working prototypes fast across very
  different domains: a real-time multilingual audio translator, an LLM agent and
  RAG platform with human-in-the-loop review, and automated financial workflows
  on the Interactive Brokers API.
