...
ogImage: images/og/efishery.png
...
labels:
    ...
    - MLOps
    - Team Lead
summary: Created Mas Ahya, the LLM assistant for fish farmers showcased by Satya Nadella at Microsoft AI Day, then led the AI squad and cut LLM ops costs by up to 80%.
describe-opening: >
  eFishery, Indonesia's aquaculture unicorn, needed a way to put expert farming
  knowledge in the hands of thousands of fish and shrimp farmers. I initiated the
  company's first LLM research project in the R&D division and turned it into
  <strong>Mas Ahya</strong>, a generative-AI conversational assistant that answers farmers'
  questions with grounded, real-time data. It reached the Microsoft AI Day stage,
  presented by Microsoft CEO Satya Nadella. I then stepped up as AI Squad Leader,
  running the team and the AI platform across three clouds, and along the way cut
  LLM service costs by up to 80% and monthly cloud spend by up to 60%.
