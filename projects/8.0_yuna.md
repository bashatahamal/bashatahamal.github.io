...
labels:
    ...
    - Backend
    - DevOps
summary: Recommendations, visual search, and the whole Kubernetes platform for an AI personal-styling e-commerce.
describe-opening: >
  Yuna & Co. is a fashion e-commerce platform built around AI personal styling.
  I joined as a Machine Learning Engineer and ended up owning much of the stack:
  the recommendation and image-understanding services that power styling, the
  Python/Node API layer behind them, and eventually all of DevOps. I introduced
  Kubernetes and CI/CD to the company and containerized every service across
  GCP and AWS.
